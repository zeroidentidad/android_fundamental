...
class LoginActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun generarShortcuts() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
            ...
            val shortcut = ShortcutInfo.Builder(this, "profile_dinamic_shortcut")
                    .setIntent(intent)
                    .setShortLabel(resources.getString(R.string.short_label))
                    .setLongLabel(resources.getString(R.string.long_label))
                    .setDisabledMessage(resources.getString(R.string.disabled_message))
                    .setIcon(Icon.createWithResource(applicationContext, R.drawable.ic_account_black))
                    .build()
