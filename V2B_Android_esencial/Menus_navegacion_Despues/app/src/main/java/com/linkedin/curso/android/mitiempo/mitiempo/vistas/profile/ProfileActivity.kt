...
class ProfileActivity : BaseActivity(), View.OnClickListener {
    ...
    private lateinit var mLoadingAnim: LottieAnimationView
    ...
    override fun initViews() {
        ...
        mLoadingAnim = findViewById(R.id.activity_profile_animacion_loading)
        mLoadingAnim.visibility = View.VISIBLE
    }
    ...
    private fun rellenarDatosProfile(profile: ModelosProfile.Resultado) {
        ...
        val handler = Handler()
        handler.postDelayed({
            mLoadingAnim.visibility = View.GONE
            val preferencias = MiSharedPref(baseContext)
            val result = StringBuilder()
                    .append(preferencias.recogerString(MiSharedPref.LONGITUD_KEY, "No item"))
                    .append(" - ")
                    .append(preferencias.recogerString(MiSharedPref.LATITUD_KEY, "No item"))
            Dialogo.miToast(context = baseContext, message = result)
        }, 3000)
