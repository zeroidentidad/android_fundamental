...
class Examples {
    ...
    fun buclesKotlin() {
        ...
        // Bucle While
        var dia = 1
        L.d("Empiza la semana")
        while (dia < 6) {
            if (dia == 1) {
                L.d("$dia dia trabajando")
            } else {
                L.d("$dia dias trabajando")
            }
    ...
    fun condicionalesKotlin() {
        ...
        L.d("Como una expresion -> $result3")
    ...
    fun clasesHerencias() {
        val miPersona = Persona("Juan", "Perez", 30)
        val miEmpleado = Empleado("Maria", "Sanchez", 32, 1L)
