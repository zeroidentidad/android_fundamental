...
import com.linkedin.curso.android.mitiempo.mitiempo.servicios.AlarmaUsoServicio
import com.linkedin.curso.android.mitiempo.mitiempo.utils.L
import com.linkedin.curso.android.mitiempo.mitiempo.vistas.saludo.SaludoActivity
...
class LoginActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // iniciarServicioSencillo()
    }

    private fun iniciarServicioSencillo() {
        val i = Intent(this@LoginActivity, AlarmaUsoServicio::class.java)
        this@LoginActivity.startService(i)
    }
    ...
    fun initViewModels() {
        ...
        mUserViewModel.setUp(application)
        mContadorTextView?.text = (++mUserViewModel.contador).toString()

        // Crear un observer para actualizar la UI
        val nameObserver = Observer<String> {
            // Actualiza la UI
            mCambioInformacionTextView?.text = it.toString()
        }

        // Observa el LiveDataObserve the LiveData, pasando esta actividad como el LifecycleOwner y el observer
    ...
    fun initObservers() {
        mUserViewModel.mTodosUsuarios.observe(this, Observer<List<Usuario>> { t ->
            t?.forEach {
                L.d("Mi usuario cambia -> ${it.id} -- email -> ${it.email}")
            }
        })
    }
    ...
    private fun updateUI(user: FirebaseUser?) {
        ...
        if (user != null) {
            ...
            // TODO:: Generar los shortcuts

            // Incluimos un intent para llamar a la siguiente actividad si ya estamos logados
    ...
    private fun generarShortcuts() {
        // TODO:: Esta característica se encuentra disponible a partir del sdk 25
        // TODO:: crear el shortcurManger
        // TODO:: Crear el intent que desencadenará la acción del shortcut

        // TODO:: Crear el shortcut
        // TODO:: Incluir el intent
        // TODO:: incluir el label de la pantalla de inicio
        // TODO:: incluir el label de la pantalla de shortcut
        // TODO:: incluir el texto de deshabilitar el shortcut
        // TODO:: incluir el icono
        // TODO:: crear con el buil el shortcut

        // TODO:: añadir el conjunto de shortcuts al manager
    }
        ...
        mAuth?.signInWithCredential(credential)
                ?.addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        ...
                        updateUI(user)
                        mUserViewModel.insertarDatosUsuario(Usuario(
                                id = user?.uid!!,
                                email = user.email!!
                        ))
                    } else {
